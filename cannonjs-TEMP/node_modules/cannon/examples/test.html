	...
	<body>
		...
		<script>
            ...
            var tab = [];
                ...
                var meshNames = [{name:"GHaut", x:"",y:"",z:""},{name:"GMillieu", x:"",y:"",z:""},{name:"GBas", x:"",y:"",z:""},{name:"DHaut", x:"",y:"",z:""},{name:"DMillieu", x:"",y:"",z:""},{name:"DBas", x:"",y:"",z:""}];
           ...
           LoadTxt();
            ...
            function LoadTxt() {
                ...
                textloader.load('unbou.json', function(font) {
                ...
                var geoCompetences = new THREE.TextGeometry('Compétences', {
                    font: font,
                    size: 0.4,
                    height: 0.05,  
                });
                ...
                var geoCertifications = new THREE.TextGeometry('Certifs Suivie', {
                    font: font,
                    size: 0.4,
                    height: 0.05,
                });
                ...
                certifications.position.set(9.1,-4,0.159999999999999973);
                ...
                documentations.position.set(-8.75,-4,1.39);
                ...
                parcours.position.set(-9.6,0,1.3499999999999999);
            ...
            function initModels(){
                ...
                loader.load( 'blanc.glb', function ( gltf ) {
                    ...
                    meshNames.forEach((meshName) =>{
                        ...
                        tab[meshName.name] = gltf.scene;
                        scene.add(tab[meshName.name]);

                    })

                    console.log(tab["GHaut"]);



                    
                    // // on position le mesh en haut a gauche de l'écran
                    // tab[0].obj.position.set(-11,4,0)
                    // // on ajoute le mesh a la scène
                    // scene.add(tab[0].obj)
                    // tab[0].obj.castShadow = true
                    // tab[0].obj.receiveShadow = true
                    // tab[0].obj.children[1].material.metalness = 0;



                    // GHaut = gltf.scene
                    // // on position le mesh en haut a gauche de l'écran
                    // //GHaut.position.set(-11,4,0)
                    // // on ajoute le mesh a la scène
                    // scene.add(GHaut)
                    // GHaut.castShadow = true
                    // GHaut.receiveShadow = true
                    // GHaut.children[1].material.metalness = 0;
                 ...
                 loader.load( 'blanc.glb', function ( gltf ) {
                    ...
                    GBas.position.set(-11,-4,0)
                    GBas.scale.z = 1.5;
                    GBas.rotation.y = Math.PI*0.55
                    scene.add(GBas)
                    GBas.castShadow = true
                    GBas.receiveShadow = true
                    GBas.children[1].material.metalness = 0;
                 ...
                 //on load le model 3d meteor.glb de la météorite (blender)
                //  loader.load( 'mete.glb', function ( gltf ) {
                //     meteorMesh = gltf.scene
                //     meteorMesh.scale.set(0.2,0.2,0.2)
                //     meteorMesh.position.set(15,10,0)
                //     scene.add(meteorMesh)
                //     // meteorMesh.castShadow = true
                //     // meteorMesh.receiveShadow = true
                //     // meteorMesh.children[1].material.metalness = 0;
